...
public final class newOrder_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 session.removeAttribute(Constants.SESSION_ORDER_DTO); 
  ...
  private boolean _jspx_meth_tiles_005finsert_005f0(PageContext _jspx_page_context)
    ...
    // /order/newOrder.jsp(26,0) name = definition type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005finsert_005f0.setDefinition("order.create.customer_sel");
    // /order/newOrder.jsp(26,0) name = flush type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
